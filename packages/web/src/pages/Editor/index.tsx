...
export function Editor() {
  return (
    <div className="min-h-screen min-h-[100dvh] bg-gradient-to-b from-emerald-50/90 to-teal-50/50 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
      ...
      <main className="max-w-7xl mx-auto flex flex-col gap-3 px-2 py-3 sm:gap-4 sm:px-4 sm:py-4 lg:flex-row lg:items-stretch lg:gap-6 lg:px-6 lg:py-6">
        ...
        <aside className="order-2 w-full flex-shrink-0 lg:order-3 lg:w-72">
          <div className="pc-panel p-3 sm:p-3.5">
            <ControlPanel />
          </div>
        </aside>
      </main>
